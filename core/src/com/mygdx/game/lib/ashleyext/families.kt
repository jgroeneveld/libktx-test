...
// copy of Ktx.Ashley because its great
...
private fun toJavaClassArray(components: Array<out KClass<out Component>>): Array<Class<out Component>> = Array(components.size) { index -> components[index].java }
